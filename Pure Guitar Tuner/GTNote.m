...
- (void)calculateCurrentNote:(double)freqency
{
    if (freqency < FSharp4 && freqency > E4) {
        ...
        self.currentNote = @"E";
    } else if (freqency < DSharp4 && freqency > CSharp4) {
        self.currentNote = @"D";
    } else if (freqency < CSharp4 && freqency > B3) {
        self.currentNote = @"C";
    } else if (freqency < C4 && freqency > ASharp3) {
        self.currentNote = @"B";
    } else if (freqency < ASharp3 && freqency > GSharp3) {
        self.currentNote = @"A";
    } else if (freqency < GSharp3 && freqency > FSharp3) {
        self.currentNote = @"G";
    } else if (freqency < FSharp3 && freqency > E3) {
        self.currentNote = @"F";
    } else if (freqency < F3 && freqency > DSharp3) {
        self.currentNote = @"E";
    } else if (freqency < DSharp3 && freqency > CSharp3) {
        self.currentNote = @"D";
    } else if (freqency < CSharp3 && freqency > B2) {
        self.currentNote = @"C";
    } else if (freqency < C3 && freqency > ASharp2) {
        self.currentNote = @"B";
    } else if (freqency < ASharp2 && freqency > GSharp2) {
        self.currentNote = @"A";
    } else if (freqency < GSharp2 && freqency > FSharp2) {
        self.currentNote = @"G";
    } else if (freqency < FSharp2 && freqency > E2) {
        self.currentNote = @"F";
